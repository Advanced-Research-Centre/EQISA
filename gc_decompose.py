...
from qiskit.synthesis.discrete_basis.gate_sequence import _check_is_so3, GateSequence
...
def is_identity_matrix(mat, ignore_phase=False, rtol=1e-05, atol=1e-05):
    ...
    iden = np.eye(len(mat), dtype=complex)
    # print("Checking mat, ", mat)
